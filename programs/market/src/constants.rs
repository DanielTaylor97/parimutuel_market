...
// WAGERS
pub const MAX_ALLOWED_TIMEOUT: i64 = 14*24*60*60;   // 2 weeks (s)
pub const MIN_ALLOWED_TIMEOUT: i64 = 24*60*60;      // 1 day (s)
pub const MAX_WAGERS: u16 = 10_000;                 // Max number of people placing wagers
pub const MIN_WAGER: u64 = 100_000;                 // Minimum wager to enter the market
...
pub const MAX_CONSOLIDATION_PERIOD: i64 = 72*60*60; // 3 days (s)
